...
### カスタムデータエレメント一覧をエクセル CSV 形式でダウンロード

1. YTM 管理画面でいずれかのページを開く
2. 拡張のアイコンをクリックする
3. YTM Exporter の下にある `カスタムデータエレメントをエクスポート` をクリックする
4. 進捗バーが 100% になると CSV ファイルに保存されます
...
| 列名                                   | 例                      | 説明                     |
| -------------------------------------- | ----------------------- | ------------------------ |
| ID                                     | 1234567                 | スクリプト毎に一意な数値 |
| 名前                                   | URL 取得                |                          |
| ページ ID                              | 2234567                 |                          |
| ページ名                               | 申込完了ページ          |                          |
| データバインディングエクスプレッション | `location.href`         |                          |
| 作成日                                 | 2019年1月25日(金) 15:38 |                          |
| 更新日                                 | 2019年3月6日(水) 11:30  |                          |
